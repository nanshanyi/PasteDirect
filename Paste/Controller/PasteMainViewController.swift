...
class PasteMainViewController: NSViewController {
    ...
    func reLayoutFrame() {
        veView.frame = view.bounds
        scrollView.contentView.setFrameSize(view.bounds.size)
...
extension PasteMainViewController:NSSearchFieldDelegate {
    ...
    func controlTextDidChange(_ obj: Notification) {
        guard let textView = obj.userInfo?["NSFieldEditor"] as? NSTextView else { return }
        let keyWord = textView.string
        if !keyWord.isEmpty {
